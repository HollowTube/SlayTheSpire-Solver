...
pub(crate) fn move_from_sts2(monster_id: MonsterId, sts2_id: &str) -> Option<&'static str> {
    match (monster_id, sts2_id) {
        ...
        // ── Ruby Raiders ──
        (MonsterId::AxeRubyRaider, "SWING_1") => Some("Swing 1"),
        (MonsterId::AxeRubyRaider, "SWING_2") => Some("Swing 2"),
        (MonsterId::AxeRubyRaider, "BIG_SWING") => Some("Big Swing"),
        (MonsterId::AssassinRubyRaider, "KILLSHOT_MOVE") => Some("Killshot"),
        (MonsterId::BruteRubyRaider, "BEAT_MOVE") => Some("Beat"),
        (MonsterId::BruteRubyRaider, "ROAR_MOVE") => Some("Roar"),
        (MonsterId::CrossbowRubyRaider, "FIRE_MOVE") => Some("Fire"),
        (MonsterId::CrossbowRubyRaider, "RELOAD_MOVE") => Some("Reload"),
        (MonsterId::TrackerRubyRaider, "TRACK_MOVE") => Some("Track"),
        (MonsterId::TrackerRubyRaider, "HOUNDS_MOVE") => Some("Hounds"),
        // ── Kin ──
        (MonsterId::KinPriest, "ORB_OF_FRAILTY_MOVE") => Some("Orb of Frailty"),
        (MonsterId::KinPriest, "ORB_OF_WEAKNESS_MOVE") => Some("Orb of Weakness"),
        (MonsterId::KinPriest, "BEAM_MOVE") => Some("Soul Beam"),
        (MonsterId::KinPriest, "RITUAL_MOVE") => Some("Dark Ritual"),
        (MonsterId::KinFollower, "QUICK_SLASH_MOVE") => Some("Quick Slash"),
        (MonsterId::KinFollower, "BOOMERANG_MOVE") => Some("Boomerang"),
        (MonsterId::KinFollower, "POWER_DANCE_MOVE") => Some("Power Dance"),
        // ── Overgrowth regulars ──
        (MonsterId::SlitheringStrangler, "CONSTRICT") => Some("Constrict"),
        (MonsterId::SlitheringStrangler, "TWACK") => Some("Thwack"), // game typo: TWACK not THWACK
        (MonsterId::SlitheringStrangler, "LASH") => Some("Lash"),
        (MonsterId::SnappingJaxfruit, "ENERGY_ORB_MOVE") => Some("Energy Orb"),
        (MonsterId::CubexConstruct, "CHARGE_UP_MOVE") => Some("Charge Up"),
        (MonsterId::CubexConstruct, "REPEATER_MOVE") => Some("Repeater Blast"),
        (MonsterId::CubexConstruct, "REPEATER_MOVE_2") => Some("Repeater Blast"),
        (MonsterId::CubexConstruct, "EXPEL_BLAST") => Some("Expel Blast"),
        (MonsterId::PhrogParasite, "INFECT_MOVE") => Some("Infect"),
        (MonsterId::PhrogParasite, "LASH_MOVE") => Some("Lash"),
        (MonsterId::Wriggler, "NASTY_BITE_MOVE") => Some("Nasty Bite"),
        (MonsterId::Wriggler, "WRIGGLE_MOVE") => Some("Wriggle"),
        (MonsterId::Mawler, "RIP_AND_TEAR_MOVE") => Some("Rip and Tear"),
        (MonsterId::Mawler, "ROAR_MOVE") => Some("Roar"),
        (MonsterId::Mawler, "CLAW_MOVE") => Some("Claw"),
        (MonsterId::VineShambler, "GRASPING_VINES_MOVE") => Some("Grasping Vines"),
        (MonsterId::VineShambler, "SWIPE_MOVE") => Some("Swipe"),
        (MonsterId::VineShambler, "CHOMP_MOVE") => Some("Chomp"),
        (MonsterId::BygoneEffigy, "INITIAL_SLEEP_MOVE") => Some("Sleep"),
        (MonsterId::BygoneEffigy, "SLEEP_MOVE") => Some("Sleep"),
        (MonsterId::BygoneEffigy, "WAKE_MOVE") => Some("Wake"),
        (MonsterId::BygoneEffigy, "SLASHES_MOVE") => Some("Slashes"),
        (MonsterId::Flyconid, "VULNERABLE_SPORES_MOVE") => Some("Vulnerable Spores"),
        (MonsterId::Flyconid, "FRAIL_SPORES_MOVE") => Some("Frail Spores"),
        (MonsterId::Flyconid, "SMASH_MOVE") => Some("Smash"),
        (MonsterId::Fogmog, "ILLUSION_MOVE") => Some("Illusion"),
        (MonsterId::Fogmog, "SWIPE_MOVE") => Some("Swipe"),
        (MonsterId::Fogmog, "SWIPE_RANDOM_MOVE") => Some("Swipe"),
        (MonsterId::Fogmog, "HEADBUTT_MOVE") => Some("Headbutt"),
        (MonsterId::CeremonialBeast, "STAMP_MOVE") => Some("Stamp"),
        (MonsterId::CeremonialBeast, "PLOW_MOVE") => Some("Plow"),
        (MonsterId::CeremonialBeast, "STUN_MOVE") => Some("Stun"),
        (MonsterId::CeremonialBeast, "BEAST_CRY_MOVE") => Some("Beast Cry"),
        (MonsterId::CeremonialBeast, "STOMP_MOVE") => Some("Stomp"),
        (MonsterId::CeremonialBeast, "CRUSH_MOVE") => Some("Crush"),
        _ => None,
    }
}
