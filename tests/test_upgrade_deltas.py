...
def test_strike_deals_6_damage():
    ...
    resolved = apply(apply(state, "PlayCard:Strike"), "SelectTarget:Monster:0")
...
def test_bash_deals_8_damage_and_applies_2_vulnerable():
    ...
    resolved = apply(apply(state, "PlayCard:Bash"), "SelectTarget:Monster:0")
...
def test_barricade_costs_3_energy():
    ...
    resolved = apply(state, "PlayCard:Barricade")
