...
def test_setup_strike_deals_7_and_grants_2_strength_this_turn_only():
    ...
    after_setup = apply(apply(state, "PlayCard:Setup Strike"), "SelectTarget:Monster:0")
    ...
    after_turn = apply(after_strike, "EndTurn")
...
def test_evil_eye_grants_8_block_or_16_if_exhausted_a_card_this_turn():
    ...
    after_no_exhaust = apply(state, "PlayCard:Evil Eye")
...
def test_forgotten_ritual_grants_3_energy_and_exhausts():
    ...
    resolved = apply(state, "PlayCard:Forgotten Ritual")
