...
def _strike_and_target(state):
    ...
    return apply(apply(state, "PlayCard:Strike"), "SelectTarget:Monster:0")
...
def test_wake_grants_10_strength():
    ...
    state = _effigy()
    a1 = apply(state, "EndTurn")  # Sleep (no-op)
    a2 = apply(a1, "EndTurn")  # Wake
...
def test_slashes_deals_13_damage():
    ...
    state = _effigy()
    a1 = apply(state, "EndTurn")  # Sleep
    a2 = apply(a1, "EndTurn")  # Wake (+10 Strength)
    a3 = apply(a2, "EndTurn")  # Slashes (13 + 10 = 23)
...
def test_slashes_repeats_forever():
    ...
    a1 = apply(state, "EndTurn")  # Sleep
    a2 = apply(a1, "EndTurn")  # Wake
    a3 = apply(a2, "EndTurn")  # Slashes
    a4 = apply(a3, "EndTurn")  # Slashes
    a5 = apply(a4, "EndTurn")  # Slashes
